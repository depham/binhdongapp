...
DuLieuTron.getTotal_M_CE1_ByConditions = function(conditions, result){
  var query = "SELECT SUM(M_CE1) AS total FROM dulieutronbd"; // Thay thế 'columnName' bằng tên cột bạn muốn tính tổng
  var params = [];
  var values = [];
